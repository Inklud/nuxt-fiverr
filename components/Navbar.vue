<template>
  <div class="bg-lipscore-red">
    <nav
      class="max-w-5xl mx-auto bg-lipscore-red h-12 flex items-center lg:items-stretch justify-between shadow relative z-10"
    >
      <NavbarBrand />
      ...
      >
        ...
        <div class="font-medium">
          <!--<ul class="inline-block mr-3" style="padding-right: 1px">
            <Navbaritems
